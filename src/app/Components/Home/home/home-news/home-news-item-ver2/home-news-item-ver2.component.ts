...
@Component({
  selector: 'app-home-news-item-ver2',
  templateUrl: './home-news-item-ver2.component.html',
  styleUrls: ['./home-news-item-ver2.component.scss'],
  animations: [
    trigger('imageDisplay', [
      state('displayed', style({opacity: '1'})),
      state('hidden', style({opacity: '0'})),
      transition('displayed <=> hidden', animate('1500ms cubic-bezier(0.74, 0.97, 0.91, 1)')),
    ]),
  ],

})
export class HomeNewsItemVer2Component implements OnInit {
